...
function toggleSeries(header) {
    ...
    // Cerrar TODAS las tarjetas expandidas de toda la página
    const allExpandedCards = document.querySelectorAll('.series-card.expanded');
    allExpandedCards.forEach(c => c.classList.remove('expanded'));
